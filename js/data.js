...
window.Data = (() => {
  ...
  const WARMUP = {
    chest_shoulders: {
      ...
      duration: '7–8 דקות (חשוב למתחיל!)',
      phases: [
        {
          phase: '🏃 שלב 1 — חימום כללי (2–3 דקות)',
          steps: [
            { action: 'ריצה קלה / הליכה מהירה', detail: '3–5 דקות — חובה לפני OHP ו-Bench Press. הגוף צריך להיות חמים!' },
      ...
      phases: [
        {
          phase: '🏃 שלב 1 — חימום כללי (2–3 דקות)',
          steps: [
            { action: 'ריצה קלה / הליכה מהירה', detail: '3–5 דקות — זרימת דם לשרירי הגב והזרועות' },
      ...
      phases: [
        {
          phase: '🏃 שלב 1 — חימום כללי (2–3 דקות)',
          steps: [
            { action: 'ריצה קלה / הליכה מהירה', detail: '3–5 דקות — חובה לפני סקוואט ודדליפט. הכי קריטי מבין 3 הימים!' },
